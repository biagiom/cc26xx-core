 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/ztree/library/trees/emt/emt-d09/src/bundles/energia/cc26xx/configPkg/package/cfg/energia_pm3g");
 ...
 */
xdc__META(__PLAT__, "@(#)__PLAT__ = ti.platforms.emt26xx");
...
/*
 * ======== ti.platforms.emt26xx.Platform TEMPLATE ========
 */

UChar ti_platforms_emt26xx_stack[1024] __attribute__ ((aligned(8), section (".stack")));
